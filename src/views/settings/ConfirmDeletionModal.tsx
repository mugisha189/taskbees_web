...
const ConfirmDeletion: React.FC<DeleteModalProps> = ({
  handleSubmit,
  closeModal,
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-[#000000] bg-opacity-30 z-50">
      <div className="bg-white rounded-[20px] shadow-lg p-6 md:w-[600px] w-full">
...
<IoClose/>
        ...
        <p className='text-center text-lg font-bold mb-4'>Are you sure you want to delete this Account?</p>
