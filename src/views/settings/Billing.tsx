  ...
  return (
    <div className="col-span-8 overflow-hidden rounded-xl sm:bg-gray-50 sm:px-8 sm:shadow">
      ...
      <div className="mb-10">
        ...
        <p className="inline-flex  items-center rounded-full bg-rose-100  py-1 text-rose-600">
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <button className="ml-auto bg-red-600 text-white h-[40px] rounded-md px-[10px] text-sm font-semibold">
