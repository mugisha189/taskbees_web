      ...
      <div className="bg-white border py-[40px] rounded-lg mx-auto mt-[30px] h-[calc(100vh-100px)] overflow-auto text-black w-full pl-0 lg:pl-10">
        <div className="container mx-auto px-4 py-8">
          ...
          <div>
            ...
            <div className="mb-2">
              <span>Represented by:</span> <span>{user?.profile.fullnames}</span>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mb-2">
              <span>Date of Birth:</span> <span>{ user?.profile.date_of_birth}</span>
            </div>
            <div className="mb-2">
          ...
          <section className="mb-2">
            <h2 className="text-lg font-medium">1. Subject of the Agreement</h2>
            <p className="mt-2"></p>
          </section>
          <section className="mb-2">
          ...
          <section className="mb-4">
            ...
            <ul className="list-disc list-inside pl-4 mt-2">
              ...
              <li>b) Provisions on remuneration and minimum wage (Part 6).</li>
            ...
            <ul className="list-disc list-inside pl-4 mt-2">
              <li>
                - The scope of work must not exceed 300 hours in a calendar year
          ...
          <section className="mb-4">
            <h2 className="text-lg font-medium">9. Personal Data Processing</h2>
            <span className="mt-2">
              9.1 The Employee acknowledges that the Employer will process their
              personal data for the purposes of this agreement and to fulfill
              legal obligations.
            </span>
            <div className="mt-2">
              9.2 The Employer will handle all personal data in accordance with
          ...
          <section className="mb-4">
            ...
            <div className="flex flex-col">
              ...
              <span className="mt-2">
                10.3 By signing this agreement, the Employee confirms that they
                have been acquainted with rights and obligations arising from
                this agreement, as well as working conditions and regulations on
        ...
        <Button  onClick={() => {
            ...
            className="bg-[#000000] py-[15px] " type="primary">
          Sign Agreement
        </Button>
      </div>
      </div>
      ...
      >
        ...
        </Tabs>
        {
          activeTab === "name" && (
            <div className="flex flex-col gap-2">
              <p>Names</p>
              <CustomInput  title="Full Name" onChange={(e)=>{setFullNames(e.target.value)}} value={fullNames} />
            </div>
          )
        }
        {
          activeTab === "signature" && (
            <div className="flex flex-col gap-2">
              <Upload type="drag" multiple={false} name="file" onChange={(e) => { console.log(e) }}>
                <div className="flex flex-col items-center gap-2">
                   <UploadIcon/>
                  <p className="text-center">Drag and drop a file or click to upload</p>
