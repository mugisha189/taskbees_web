...
import CandidateProfileSkeleton from "@/skeleton/CandidateProfileSkeleton";
  ...
  return (
    <div className="flex w-full flex-col gap-5">
      <div className="flex justify-end px-2 pt-[20px]">
        <button className="bg-brand-400 text-white h-[40px] p-3 rounded-md items-center justify-center flex " onClick={()=>navigate("edit")}>Contact</button>
      </div>
