import { acceptCandidateApplication, applyForJob, approveForWork, createInterview, deleteJob, getAppliedJobs, getBusinessJobs, getJobApplicants, getJobById, getJobs, getJobsByStatus, inviteCandidateToInterview, publishJob, rejectCandidateApplication } from "@/api/job";
...
export const useGetJobsByStatus = (status:string,page:string, limit:string) => {
  return useQuery({
...
export const useAcceptCandidateApplication = (jobId:string|undefined,candidateId:string|undefined) => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationKey: ["acceptCandidateApplication", jobId,candidateId],
    
    mutationFn: ({ jobId, candidateId }: { jobId: string | undefined, candidateId: string | undefined }) => acceptCandidateApplication(jobId, candidateId),
    onSuccess: () => {
...
export const useApproveForWork = (jobId:string|undefined,candidateId:string|undefined) => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationKey: ["approveForWork", jobId,candidateId],
    
    mutationFn: ({ jobId, candidateId }: { jobId: string | undefined, candidateId: string | undefined }) => approveForWork(jobId, candidateId),
    onSuccess: () => {
...
export const useRejectCandidateApplication = (jobId:string|undefined,candidateId:string|undefined) => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationKey: ["rejectCandidateApplication", jobId,candidateId],
    
    mutationFn: ({ jobId, candidateId }: { jobId: string | undefined, candidateId: string | undefined }) => rejectCandidateApplication(jobId, candidateId),
    onSuccess: () => {
...
export const useInviteCandidateToInterview = (jobId:string|undefined,candidateId:string|undefined) => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationKey: ["inviteCandidateToInterview", jobId,candidateId],
    
    mutationFn: ({ jobId, candidateId }: { jobId: string | undefined, candidateId: string | undefined }) => inviteCandidateToInterview(jobId, candidateId),
    onSuccess: () => {
...
export const useApplyForJob = (jobId:string|undefined) => {
  ...
  return useMutation({
    ...
    mutationFn: ({ jobId }: { jobId: string | undefined }) => applyForJob(jobId),
    onSuccess: () => {
