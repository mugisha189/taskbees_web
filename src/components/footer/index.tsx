...
function Footer() {
  return (
    ...
    <div className="mx-auto max-w-screen-3xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-2">
          ...
          <div>
            ...
            <ul className="mt-6 space-y-4 text-sm">
              ...
              <li>
                <a href="#" className="text-gray-700 transition hover:opacity-75"> Terms of use </a>
              </li>
